...
mixin _$Settings {
  @HiveField(0)
  bool get blockAd => throw _privateConstructorUsedError;
  @HiveField(1)
  bool get soundsOn => throw _privateConstructorUsedError;
  @HiveField(2)
  DateTime? get firstEnter => throw _privateConstructorUsedError;
  @HiveField(3)
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      blockAd: null == blockAd
          ? _value.blockAd
          : blockAd // ignore: cast_nullable_to_non_nullable
              as bool,
      soundsOn: null == soundsOn
          ? _value.soundsOn
          : soundsOn // ignore: cast_nullable_to_non_nullable
              as bool,
      firstEnter: freezed == firstEnter
          ? _value.firstEnter
          : firstEnter // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      isNotificationEnable: freezed == isNotificationEnable
...
class _$SettingsImpl implements _Settings {
  const _$SettingsImpl(
      {@HiveField(0) this.blockAd = false,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.blockAd, blockAd) || other.blockAd == blockAd) &&
            (identical(other.soundsOn, soundsOn) ||
                other.soundsOn == soundsOn) &&
            (identical(other.firstEnter, firstEnter) ||
                other.firstEnter == firstEnter) &&
